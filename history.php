  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <a href="userh.php" class="nav-item nav-link active">Home</a>
        <a href="userh.php" class="nav-item nav-link">About</a>
        <a href="userh.php" class="nav-item nav-link">Services</a>
        <a href="userh.php" class="nav-item nav-link">Contact</a>
...
";
    ...
    <td>
      ...
      <a name='' id='butt' class='btn btn-danger' href='deleteappoint.php?id={$rows['id']}' role='button'
        >Delete</a
      >
    </td>
  </tr>
